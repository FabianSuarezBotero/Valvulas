...
def main():
    ...
    button_vaciart3 = tk.Button(window,text="Vaciar T3", command=tanque3.vaciar)
    button_vaciart3.pack()
    button_vaciart3.place(x=420, y=620)

    button_fogon = tk.Button(window,text="Fogon ⬆", command=cal.subir_temperatura)
    button_fogon.pack()
    button_fogon.place(x=560, y=620)

    button_fogon = tk.Button(window,text="Fogon ⬇", command=cal.bajar_temperatura)
    button_fogon.pack()
